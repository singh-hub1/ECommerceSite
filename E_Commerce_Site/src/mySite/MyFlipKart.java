...
public class MyFlipKart {
    ...
    public static void main(String[] args) {
        ...
        // Creating Customer --> Vishal
        Customer Vishal = new Customer("VISHAL SINGH","9370735015");
        ...
        Vishal.addItemToCart(milkTenPackets);

        // Printing current cart status
        Vishal.printCartItems();
        ...
        Vishal.addItemToCart(oneCamera);

        // Printing current cart status
        Vishal.printCartItems();

        // Customer updating quantity of milk packets from 10 to 15
        Vishal.updateItemCount(milkTenPackets,15);
        ...
        System.out.println(Vishal.getCurrentOrder());

        // Customer order is moved to shipment
        Shipment s = Vishal.getCurrentOrder().moveToShipment();
